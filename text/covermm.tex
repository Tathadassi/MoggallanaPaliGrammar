...
% 虚拟出版社
\newcommand{\plogo}{\faBook \space ဓမ္မဒါန \faLightbulb[regular]} % Generic dummy publisher logo
...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	{\LARGE \textbf{မောဂ္ဂလ္လာန် ပါဠိသဒ္ဒါကျမ်း}\\} % Title
	...
	\palimm{တမူထူးခြား​သော ရှေး​ဟောင်း ပါဠိသဒ္ဒါကျမ်း} % Subtitle or further description
